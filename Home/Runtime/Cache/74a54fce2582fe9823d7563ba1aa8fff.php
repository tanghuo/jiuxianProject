<?php if (!defined('THINK_PATH')) exit(); session_start(); if(!$_SESSION["user"]){ echo "请先登录"; exit(); } var_dump($_SESSION); ?>
 <!doctype html>
 	<html lang="en">
 	<head>

 		<meta charset="UTF-8">
 		<title>酒仙网>个人中心</title>
	...
	width: 1000px;
        ...
        #uRM_three ul li a:hover{
        	text-decoration: underline;
        	color: red;
        }
        #uRM_three ul li:first-child{
        	font-size: 25px;
        }
        #uRM_three span{
        	color: red;
        ...
        #uRM_four ul li a:hover{
        	text-decoration: underline;
        	color: red;
        }
        #uRM_four ul li:first-child{
        	font-size: 25px;
        }
        #uRM_four span{
        	color: red;
		...
		<div id="user_M_Right" >
			...
			<div id="uRM_two">
				<div>
					...
					<ul>
						<li>最近订单</li>
						<li><a href="">待付款<span><?php echo ($sell_readyPay); ?></span></a></li>
						<li><a href="">待收货<span><?php echo ($sell_redyGot); ?></span></a></li>
						<li><a href="">待评价<span><?php echo ($sell_readyRate); ?></span></a></li>
						<li class="uRM_two_last"><a href="">查看全部订单&gt</li>
					</ul>
					<div id="uRM_two_tubiao"></div>
				</div>
				<div id="uRM_two_M"><a href="./index.php">您买的东西太少了，这里空空的，快去挑选合适的商品吧</a>
			...
			<div id="uRM_three">
				<div>
					...
					<ul>
						...
						<li><a href=""> <span> </span></a></li>
						<li><a href=""> <span> </span></a></li>
						<li class="uRM_two_last"><a href=""></li>
					</ul>
					<div id="uRM_three_tubiao"></div>
				</div>
				<div id="uRM_three_M"><a href="./index.php">您还没有收藏任何商品，看到感兴趣的商品就果断收藏吧！</a>
			...
			<div id="uRM_four">
				<div>
					...
					<div id="uRM_four_tubiao"></div>
				</div>
				<div id="uRM_four_M">
					<div class="uRM_Recommend">
						<a href=""><img src="__ROOT__/Home/Tpl/Index/img/user_Recommend_1.jpg" alt=""></a>
						<div ><a href="">会员俱乐部会员俱乐部会员俱乐部会员俱乐部</a></div>
						<div style="text-align:right;color:red;font-size:18px;">￥100.00</div>
					</div>
