<?php if (!defined('THINK_PATH')) exit(); session_start(); ?>
 ...
 <!doctype html>
	...
	#uRM_two{
        ...
        #uRM_Comment ul li:first-child{

        	font-size: 15px!important;

        }

        #uRM_Comment ul li:last-child{
				...
				<div>
					<ul>
						...
						<li class="uRM_two_last">
							<span>物流配送、退换货、商品损坏等售后问题您可以拨打7×24小时客服电话：<b style="color:red!important;font-size:16px!important;">400-617-9999</b>
						 	</span>
						</li>
					</ul>
 	...
 	<div id="footer">
		...
		function redNav(){
			...
			// userComment
			if(str=="userComment.php"){
				$("#UM_Lnav ul li").eq(5).css({"color":"red"});
			}
			// userConsult.php
			if(str=="userConsult.php"){
				$("#UM_Lnav ul li").eq(6).css({"color":"red"});
			}
		}
		</script>
